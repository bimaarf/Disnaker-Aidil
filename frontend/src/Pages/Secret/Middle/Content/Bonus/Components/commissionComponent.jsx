...
export const CommissionComponent = () => {
  ...
  const data = [
    {
      title: "Rebate Harian Casino",
      subTitle: `${getCurrentDate()} 00.00 WIB - ${getCurrentDate()} 23.59 WIB`,
    },
    {
      title: "Rebate Harian Slot",
      subTitle: `${getCurrentDate()} 00.00 WIB - ${getCurrentDate()} 23.59 WIB`,
    },
    {
      title: "Rebate Harian Poker",
      subTitle: `${getCurrentDate()} 00.00 WIB - ${getCurrentDate()} 23.59 WIB`,
    },
    {
      title: "Rebate Harian Sportsbook",
      subTitle: `${getCurrentDate()} 00.00 WIB - ${getCurrentDate()} 23.59 WIB`,
    },
  ];
        ...
        <div className="mt-4">
          ...
          <div className="p-3 font-body whitespace-normal">
            <div className="p-3 text-xs rounded text-white bg-neutral-500/40">
              ...
              <li className="list-decimal">
                Komisi sedang disimpan sementara selama 30 menit dari
                29-Nov-2024 07:56:04 WIB
              </li>
