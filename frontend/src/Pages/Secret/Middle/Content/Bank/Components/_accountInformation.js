...
export const AccountInformation = ({ currentUser }) => {
  return (
    <div className="mt-4 md:border border-base-300">
      ...
      <div className="p-3 font-body">
        <div className="md:flex items-start gap-4 space-y-4 md:space-y-0">
          <div className="md:w-1/2 bg-base-100/10 uppercase text-white text-sm font-medium space-y-4 p-4">
          ...
          <div className="md:w-1/2 bg-base-100/10 uppercase text-white text-sm font-medium space-y-3 p-4">
            <div className="flex justify-between items-start">
              <h1>Detail Perbankan</h1>
              <button className="bg-violet-500/30 hover:brightness-90 px-3 py-1 rounded">
