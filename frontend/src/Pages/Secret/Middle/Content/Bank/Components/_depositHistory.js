            ...
            <div className="md:w-1/2 bg-base-100/10 text-white text-sm space-y-4">
              ...
              <table className="table">
                <thead className="bg-neutral-500/40">
                  <tr>
                    <th>
                      <p className="font-medium text-primary-content">Jumlah</p>
                    </th>
                    <th>
                    ...
                    <th>
                      <p className="font-medium text-primary-content">Status</p>
                    </th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-base-300 border-dashed">
                    <td>
                      <p className="font-medium text-primary-content">
                        Rp 500.000
                      </p>
