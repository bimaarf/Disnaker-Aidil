...
export const DepositPreview = ({ selectedData, onClose }) => {
  ...
  const handleUpload = () => {
    if (file && selectedData) {
      ...
      dispatch(
        updateDeposit({ key: selectedData.key, depositData: formData })
      ).then(() => {
      ...
      <div
        ...
        <div className="py-4">
          ...
          {selectedData.image && (
            <div className="mb-4 flex justify-center">
              <img
                src={`${process.env.REACT_APP_API}deposit/images/${selectedData.image}`}
          ...
          <div className="text-md mb-4">
            <h1 id="deposit-modal-title" className="font-medium">
              {selectedData.amount}
            </h1>
          </div>
        ...
        {user.role === "administrator" && (
          <div className="flex justify-end items-center gap-2">
            <button
              onClick={() => navigate("/deposit/preview/" + selectedData.key)}
