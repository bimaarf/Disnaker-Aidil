      ...
      <div className="flex items-center justify-between p-2 gap-3">
        ...
        <div
          ...
          <div className="w-full">
            ...
            <p className="text-xs text-neutral">{data.payment.title}</p>
          </div>
          <div className="text-right w-1/5">
            <div className="flex justify-end items-center gap-1">
              <span className={`material-symbols-outlined text-sm ${!data.account_name && 'text-neutral'}`}>wallet</span>

              <p className={`text-xs whitespace-nowrap ${!data.account_name && 'text-neutral'}`}>
