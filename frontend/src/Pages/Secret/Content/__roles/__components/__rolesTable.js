        ...
        <tr>
          ...
          <th>
            <div
              ...
              className="flex items-center">
              Display Name{" "}
              {sortConfig.display_name === "display_name"
                ? sortConfig.direction === "desc"
                  ? "↓"
                  : "↑"
                : ""}
          ...
          <th>
            <div
              ...
              className="flex items-center">
              Description{" "}
              {sortConfig.description === "description"
                ? sortConfig.direction === "desc"
                  ? "↓"
                  : "↑"
                : ""}
            ...
            <tr
              ...
              <td>
                <div className="flex gap-1 items-center">
                  ...
                  <p className={`text-neutral-content`}>{data.display_name}</p>
                </div>
              </td>
              <td>
                <div className="flex gap-1 items-center">
                  <p className={`text-neutral-content`}>{data?.description}</p>
                </div>
              </td>
