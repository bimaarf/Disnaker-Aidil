...
export const EventModal = ({ selectedData, onClose }) => {
  ...
  if (!selectedData) {
    return null; // Return nothing if no event is selected
  }
        ...
        <div className="py-4">
          {selectedData.image && (
            <div className="mb-4 flex justify-center">
              <img
                src={`${process.env.REACT_APP_API}dash/event/images/${selectedData.image}`}
          ...
          <div className="text-md mb-4">
            <h1 id="event-modal-title" className="font-medium">
              {selectedData.title}
            </h1>
          </div>
