...
export const CategoryProductModal = ({ selectedData, onClose }) => {
  ...
  return (
    <div
      role="dialog"
      aria-modal="true"
      aria-labelledby="categoryProduct-modal-title"
      aria-describedby="categoryProduct-modal-description"
      ...
      <div
        ...
        <div className="py-4">
          ...
          <div className="text-md mb-4">
            <h1 id="categoryProduct-modal-name" className="font-medium">
