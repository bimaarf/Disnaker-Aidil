...
export const NotificationModal = ({ selectedData, onClose }) => {
  ...
  if (!selectedData) {
    return null; // Return nothing if no notification is selected
  }
        ...
        <div className="py-4">
          {selectedData.image && (
            <div className="mb-4 flex justify-center">
              <img
                src={`${process.env.REACT_APP_API}notification/images/${selectedData.image}`}
          ...
          <div className="text-md mb-4">
            <h1 id="notification-modal-title" className="font-medium">
              {selectedData.name}
            </h1>
          </div>
