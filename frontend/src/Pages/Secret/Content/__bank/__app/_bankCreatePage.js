...
import { createBank } from "../../../../../features/bank/bankSlice";
...
const BankCreatePage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(
        "Error creating bank account: " + (err.message || "Unknown error")
      );
      console.error(err);
    } finally {
      setLoading(false);
  ...
  return (
    <div className="min-h-screen bg-base-100">
      ...
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        <form id="bank-create-form" onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                />
                {error?.receiver_name && (
                  <p className="text-error text-sm mt-1">{error.receiver_name}</p>
                )}
              </div>
