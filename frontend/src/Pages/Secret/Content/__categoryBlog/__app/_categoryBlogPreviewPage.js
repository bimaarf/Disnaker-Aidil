...
const CategoryBlogPreviewPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`api/blog/category/${key}`);
  ...
  const handleEditData = (data) => {
    navigate(`/blog/category/update/${data.key}`, {
...
export default CategoryBlogPreviewPage;
