...
const BannerListItem = ({
  ...
  return (
    <div
      {...handlers}
      className={`relative h-20 mb-2 place-content-center border select-none border-base-300 cursor-pointer active:bg-base-200 rounded-xl swipe-container ${
      ...
      <div className="flex items-center justify-between p-2 gap-3">
        ...
        <div
          ...
          <div className="w-full">
            <div className="font-bold text-ellipsis"></div>
            <div className="flex items-center justify-between gap-1">
              <div className="text-xs text-base-300">{data.body}</div>
