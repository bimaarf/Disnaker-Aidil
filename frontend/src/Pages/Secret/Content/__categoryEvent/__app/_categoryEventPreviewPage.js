...
const CategoryEventPreviewPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`api/event/category/${key}`);
  ...
  const handleEditData = (data) => {
    navigate(`/event/category/update/${data.key}`, {
...
export default CategoryEventPreviewPage;
