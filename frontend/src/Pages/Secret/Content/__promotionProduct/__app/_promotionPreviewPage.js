...
const PromotionProductPreviewPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`api/product/promotion/${key}`);
  ...
  const handleEditData = (data) => {
    navigate(`/product/promotion/update/${data.key}`, {
...
export default PromotionProductPreviewPage;
