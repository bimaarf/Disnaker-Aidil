...
export const PromotionProductModal = ({ selectedData, onClose }) => {
  ...
  const truncateTitle = (name, limit) => {
  ...
  return (
    <div
      role="dialog"
      aria-modal="true"
      aria-labelledby="promotionProduct-modal-title"
      aria-describedby="promotionProduct-modal-description"
        ...
        <div className="py-4">
          {selectedData.image && (
            <div className="mb-4 flex justify-center">
              <img
                src={`${process.env.REACT_APP_API}${selectedData.image}`}
          ...
          <div className="text-md mb-4">
            <h1 id="promotionProduct-modal-name" className="font-medium">
              {truncateTitle(selectedData.name, 50)}
            </h1>
          </div>
