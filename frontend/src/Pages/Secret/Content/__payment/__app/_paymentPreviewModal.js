...
export const PaymentModal = ({ selectedData, onClose }) => {
        ...
        <div className="py-4">
          {selectedData.image && (
            <div className="mb-4 flex justify-center">
              <img
                src={`${process.env.REACT_APP_API}payment/images/${selectedData.image}`}
          ...
          <div className="text-md mb-4">
            <h1 id="payment-modal-title" className="font-medium">
