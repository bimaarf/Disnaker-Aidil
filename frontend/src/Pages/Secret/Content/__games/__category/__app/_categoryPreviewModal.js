...
export const CategoryModal = ({ selectedData, onClose }) => {
        ...
        <div className="py-4">
          {selectedData.image && (
            <div className="mb-4 flex justify-center">
              <img
                src={`${process.env.REACT_APP_API}category/images/${selectedData.image}`}
          ...
          <div className="text-md mb-4">
            <h1 id="category-modal-title" className="font-medium">
              {truncateTitle(selectedData.title, 50)}
            </h1>
          </div>
