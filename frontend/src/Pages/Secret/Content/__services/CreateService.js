...
const CreateService = ({ onClose, onSuccess }) => {
  ...
  const addSubItem = () => {
    if (subItemForm.title.trim()) {
      setFormData((prev) => ({
        ...prev,
        sub_items: [...prev.sub_items, { ...subItemForm }],
      }));
      setSubItemForm({
        title: "",
        description: "",
            ...
            <div className="space-y-4">
              ...
              <div className="form-control">
                ...
                <textarea
                  ...
                  className="outline-none text-sm px-4 py-2 w-full bg-base-200 dark:bg-base-300/50 focus:bg-base-100 focus:border-primary dark:focus:border-primary transition-all resize-none rounded-lg border border-base-300"
                />
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-primary/5 dark:bg-primary/10 p-4 rounded-lg border border-primary/20 space-y-3">
                ...
                <textarea
                  ...
                  className="outline-none text-sm px-4 py-2 w-full bg-base-200 dark:bg-base-200 focus:bg-base-100 focus:border-primary dark:focus:border-primary transition-all resize-none rounded-lg border border-base-300"
                />
                <div className="flex gap-3">
                  <input
                    type="url"
                    name="link"
                    value={subItemForm.link}
                    onChange={handleSubItemChange}
                    placeholder="https://example.com"
              ...
              {formData.sub_items.length > 0 && (
                <div className="space-y-2">
                  <p className="text-xs text-base-content/60 font-medium flex items-center gap-2">
                    <ChevronDown size={14} />
                    Added Sub Items ({formData.sub_items.length})
                  </p>
                  <div className="space-y-2">
