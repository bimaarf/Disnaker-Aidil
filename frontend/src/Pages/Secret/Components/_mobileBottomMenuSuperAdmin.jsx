import { BarChart3, Newspaper, User } from "lucide-react";
  ...
  const mainMenus = [
    {
      ...
      bgColor: "bg-blue-50 dark:bg-primary/30",
      url: "/dashboard",
    },
    {
      id: "Services",
      ...
      bgColor: "bg-orange-50 dark:bg-warning/30",
    ...
    },
    {
      ...
      bgColor: "bg-cyan-50 dark:bg-info/30",
      url: isAuthenticated
...
export default MobileBottomMenuSuperAdmin;
