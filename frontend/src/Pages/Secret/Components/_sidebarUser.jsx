...
// Komponen SidebarUser
export const SidebarUser = ({ isMobile, setIsOpen }) => {
  ...
  const menuSections = [
    ...
    // },
    {
      ...
      items: [
        ...
        //     // { label: "About", url: "/body", icon: ListTree },
        //     // { label: "Operational", url: "/operational", icon: CalendarClock },
        //     { label: "Gallery", url: "/banners", icon: CalendarClock },
        //   ],
        // },
