...
// Komponen SidebarSuperAdmin
export const SidebarSuperAdmin = ({ isMobile, setIsOpen }) => {
  ...
  const menuSections = [
    ...
    },
    {
      ...
      items: [
        {
          label: "Information & Articles",
          icon: Newspaper,
          color: "text-blue-500",
          subMenu: [
            { label: "Content Articles", url: "/blog", icon: Newspaper },
            { label: "Categories", url: "/category/blog", icon: Tag },
            { label: "Gallery", url: "/banners", icon: Image },
          ],
        },
        {
      ...
      items: [
        {
          ...
          subMenu: [
            ...
            { label: "About-us", url: "/body", icon: Landmark },
            { label: "Operational", url: "/operational", icon: Clock },
          ],
        },
      ],
    },
