  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="mb-4 px-4 py-2 bg-sky-500 text-white rounded-lg shadow-md hover:bg-sky-600 transition-colors">
      ...
      {isVisible && (
        <div
          ...
          <div
            className={`before:absolute before:bg-sky-500 before:w-3 before:h-12 before:top-24 before:-right-2 before:-z-10 before:rounded-2xl before:shadow-inner before:shadow-gray-50 relative w-60 h-60 bg-sky-500 shadow-inner shadow-gray-50 flex justify-center items-center rounded-3xl ${
            ...
            <div className="w-56 h-56 bg-neutral-900 shadow-inner shadow-gray-50 flex justify-center items-center rounded-3xl">
              <div className="flex flex-col items-center justify-center rounded-2xl bg-neutral-900 shadow-inner shadow-gray-50 w-52 h-52">
                <div className="before:absolute before:w-12 before:h-12 before:bg-orange-800 before:rounded-full before:blur-xl before:top-16 relative flex flex-col justify-around items-center w-44 h-40 bg-neutral-900 text-gray-50">
                  <span className="">{`${day}, ${month} ${date}`}</span>
                    ...
                    <div className="flex flex-row items-center">
                      ...
                      <svg
                        ...
                        <path
                          ...
                          className="svg-fill-primary"></path>
                      </svg>
                      <svg
                        y="0"
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="text-gray-700 text-lg font-light">nokia</span>
              </div>
            </div>
          </div>
        </div>
